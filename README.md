...
- `artifacts/final_model_best/` for the standard train-from-scratch run
- `artifacts/final_model_best/` as the recommended submission-ready adapter, selected by validation performance
